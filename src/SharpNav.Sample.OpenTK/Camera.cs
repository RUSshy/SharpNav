...
namespace SharpNav.Examples
{
	...
	public class Camera
	{
		...
		public void RotateHeadingTo(float angle)
		{
			...
			float headingRad = heading * (MathF.PI / 180f);
			...
			float headingDirection = (pitch + 90) * (MathF.PI / 180f);
		...
		public void LookAt(Vector3 position)
		{
			...
			RotatePitchTo((float)(Math.Atan2(pitchVec.Y, pitchVec.X) * (180f / MathF.PI) - 90));
			...
			RotateHeadingTo((float)Math.Asin(-lookAxis.Y) * (180f / MathF.PI));
