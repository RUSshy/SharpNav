					...
					switch (line[0])
					{
						...
						case "f":
							...
							else if (line.Length == 4)
							{
								...
								tris.Add(new Triangle3(tempVerts[v0].toNumerics(), tempVerts[v1].toNumerics(), tempVerts[v2].toNumerics()));
							...
							else
							{
								...
								for (int i = 2; i < line.Length - 1; i++)
								{
									...
									tris.Add(new Triangle3(tempVerts[v0].toNumerics(), tempVerts[vi].toNumerics(), tempVerts[vii].toNumerics()));
									norms.Add(tempNorms[n0]);
