...
namespace SharpNav.Tests
{
	...
	public class MathHelperTests
	{
		...
		{
			float num = Math.Clamp(7.56f, 6.75f, 10.89f);
		...
		{
			float num = Math.Clamp(3.89f, 6.75f, 10.89f);
		...
		{
			float num_r = 3.89f;
            num_r = Math.Clamp(num_r, 6.75f, 10.89f);
